...
/**
 * Item in *Bento → Default → Primary → RepeatableZone*
 */
export interface BentoSliceDefaultPrimaryRepeatablezoneItem {
	/**
	 * Title field in *Bento → Default → Primary → RepeatableZone*
	 *
	 * - **Field Type**: Title
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.repeatablezone[].title
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	title: prismic.TitleField;

	/**
	 * Body field in *Bento → Default → Primary → RepeatableZone*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.repeatablezone[].body
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	body: prismic.RichTextField;

	/**
	 * Image field in *Bento → Default → Primary → RepeatableZone*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.repeatablezone[].image
	 * - **Documentation**: https://prismic.io/docs/field#image
	 */
	image: prismic.ImageField<never>;

	/**
	 * Wide field in *Bento → Default → Primary → RepeatableZone*
	 *
	 * - **Field Type**: Boolean
	 * - **Placeholder**: *None*
	 * - **Default Value**: false
	 * - **API ID Path**: bento.default.primary.repeatablezone[].wide
	 * - **Documentation**: https://prismic.io/docs/field#boolean
	 */
...
export interface BentoSliceDefaultPrimary {
	...
	/**
	 * RepeatableZone field in *Bento → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.repeatablezone[]
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	repeatablezone: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryRepeatablezoneItem>>;
}
